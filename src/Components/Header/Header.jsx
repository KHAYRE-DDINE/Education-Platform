  ...
  return (
    <React.Fragment>
      {Language === "english" ? (
        ...
        <header className="bg-white z-20 fixed w-[100%] flex flex-row-reverse items-center justify-between  border-b-[1px] border-solid border-grayD">
          ...
          <nav className="relative flex flex-row-reverse items-center justify-end p-6 lg:px-8">
            <div className="hidden md:flex search-input relative !ml-[22px]">
              <CiSearch />
              <input
                type="search"
                name="search"
            ...
            <div className="hidden flex-row-reverse lg:flex lg:gap-x-5">
              <div className="box-lang flex items-center justify-around relative text-sm font-semibold leading-6 text-gray-900 capitalize">
                <div className="language-icon absolute left-0">
                  <TbWorld />
                </div>
